...
This project is an OWL-based ontology developed as part of the Knowledge Engineering and Ontologies course. It provides a structured semantic model to track pet ownership, veterinary treatments, and health data.
...
Protégé (Knowledge Engineering Tool)

Widoco (Ontology Documentation Wizard)
